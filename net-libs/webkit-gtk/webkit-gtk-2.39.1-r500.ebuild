...
IUSE="aqua avif +egl examples gamepad +gbm gles2-only gnome-keyring +gstreamer +introspection pdf +jpeg2k +jumbo-build lcms seccomp spell systemd test wayland X"
...
# Missing WebRTC support, but ENABLE_MEDIA_STREAM/ENABLE_WEBRTC is experimental upstream (PRIVATE OFF) and shouldn't be used yet in 2.30
...
BDEPEND="
	...
	|| ( >=sys-devel/gcc-9.3 >=sys-devel/clang-5 )
	sys-devel/gettext
	virtual/pkgconfig
